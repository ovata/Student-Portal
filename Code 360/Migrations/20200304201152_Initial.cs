        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(nullable: false),
                    EndDate = table.Column<DateTime>(nullable: false),
                    CompanyId1 = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmploymentDetails", x => new { x.StudentId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_EmploymentDetails_Students_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmploymentDetails_Companies_CompanyId1",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    StudentId = table.Column<Guid>(nullable: false),
                    GuarantorId = table.Column<Guid>(nullable: false),
                    Id = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGuarantors", x => new { x.StudentId, x.GuarantorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploymentDetailsStudentId = table.Column<Guid>(nullable: true),
                    EmploymentDetailsCompanyId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Salaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Salaries_EmploymentDetails_EmploymentDetailsStudentId_EmploymentDetailsCompanyId",
                        columns: x => new { x.EmploymentDetailsStudentId, x.EmploymentDetailsCompanyId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmploymentDetails_CompanyId",
                table: "EmploymentDetails",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_EmploymentDetails_CompanyId1",
                table: "EmploymentDetails",
                column: "CompanyId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Salaries_EmploymentDetailsStudentId_EmploymentDetailsCompanyId",
                table: "Salaries",
                columns: new[] { "EmploymentDetailsStudentId", "EmploymentDetailsCompanyId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGuarantors_GuarantorId",
