        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmploymentDetails_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmploymentDetails_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploymentDetailsId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Salaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Salaries_EmploymentDetails_EmploymentDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmploymentDetails_StudentId",
                table: "EmploymentDetails",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Salaries_EmploymentDetailsId",
                table: "Salaries",
